...
var NegociacaoController = function () {
    function NegociacaoController() {
        ...
        var $ = document.querySelector.bind(document); //atribuindo ao $ a funcao de executar o querySelector ainda respondendo a document e nao ao contexto do $
    ...
    _createClass(NegociacaoController, [{
        ...
        value: function apaga() {
            ...
            this._service.apaga().then(function (mensagem) {
                ...
                return _this4.mensagem.texto = err;
            });
        }
    }, {
        key: '_criaNegociacao',
        value: function _criaNegociacao() {
            return new _Negociacao.Negociacao(_DataHelper.DateHelper.textoParaData(this._inputData.value), parseInt(this._inputQuantidade.value), parseFloat(this._inputValor.value));
        }
    }, {
