            ...
            _export('DateHelper', DateHelper = function () {
                ...
                _createClass(DateHelper, null, [{
                    ...
                    value: function dataParaTexto(data) {
                        //metodo static que pertencem a definicao da classe, evita ter que instanciar uma classe
                    ...
                    value: function textoParaData(texto) {
                        ...
                        if (!/\d{2}\/\d{2}\/\d{4}/.test(texto)) throw new Error('Deve estar no formato aaaa-mm-dd'); //se o texto fornecido nao segue o padrao ano-mes-dia então exime mensagem de erro
